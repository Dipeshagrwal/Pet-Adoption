        ...
        <div class="flex-1 md:ml-72 p-6 sm:p-10 transition-all duration-300">
            <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-3xl font-semibold text-gray-800">Edit Pet Type</h2>
                ...
                <!-- Form -->
                <form action="{{ route('pet_types.update', $petType->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="pt-4">
                        <button type="submit"
                            ...
                            <i class="fas fa-save mr-2"></i> Update Pet Type
                        </button>
                    </div>
                </form>
            </div>
