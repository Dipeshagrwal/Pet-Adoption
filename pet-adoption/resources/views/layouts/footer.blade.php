<footer class="bg-gray-800 text-white py-12">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <i class="fas fa-paw text-1xl mr-2 text-primary-600"></i>
                <h4 class="text-1xl font-bold text-primary-600">PetAdoption</h4>
            </div>
                    <p class="text-gray-400">Connecting loving homes with pets in need since 2023.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#explore" class="text-gray-400 hover:text-white transition-colors duration-200">Browse Pets</a></li>
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-4">Subscribe to get updates on new pets and adoption tips.</p>
                    <form class="flex">
